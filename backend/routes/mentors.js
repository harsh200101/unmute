    ...
    try {
      ...
      let query = `
        SELECT
          ...
          r.is_anonymous,
          CASE WHEN r.is_anonymous = true THEN 'Anonymous' ELSE u.first_name END as mentee_first_name,
          CASE WHEN r.is_anonymous = true THEN '' ELSE u.last_name END as mentee_last_name,
          CASE WHEN r.is_anonymous = true THEN NULL ELSE u.avatar_url END as mentee_avatar,
